...
from ..models import Tweet, Formula1Video, CommentFormula1Video, Comment, Comment1, Comment2, Comment3
...
def get_videos_view(request, *args, **kwags):
    ...
    '''
    videos = Formula1Video.objects.all()
...
def see_all_video_comments(request, pk, *args, **kwags):
    ...
    '''
    commentedvideos = CommentFormula1Video.objects.filter(uploadedvideo=pk)
