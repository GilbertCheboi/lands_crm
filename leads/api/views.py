...
from ..models import Tweet, BundesligaVideo, CommentBundesligaVideo, Comment, Comment1, Comment2, Comment3
...
def get_videos_view(request, *args, **kwags):
    ...
    '''
    videos = BundesligaVideo.objects.all()
...
def see_all_video_comments(request, pk, *args, **kwags):
    ...
    '''
    commentedvideos = CommentBundesligaVideo.objects.filter(uploadedvideo=pk)
