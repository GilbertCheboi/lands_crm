...
from ..models import Tweet, BaseballVideo, CommentBaseballVideo, Comment, Comment1, Comment2, Comment3
...
def get_videos_view(request, *args, **kwags):
    ...
    '''
    videos = BaseballVideo.objects.all()
...
def see_all_video_comments(request, pk, *args, **kwags):
    ...
    '''
    commentedvideos = CommentBaseballVideo.objects.filter(uploadedvideo=pk)
