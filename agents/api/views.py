...
from ..models import Tweet, NFLVideo, CommentNFLVideo, Comment, Comment1, Comment2, Comment3
...
def see_all_video_comments(request, pk, *args, **kwags):
    ...
    '''
    commentedvideos = CommentNFLVideo.objects.filter(uploadedvideo=pk)
