...
from ..models import Tweet, ChampionsVideo, CommentChampionsVideo, Comment, Comment1, Comment2, Comment3
...
def get_videos_view(request, *args, **kwags):
    ...
    '''
    videos = ChampionsVideo.objects.all()
...
def see_all_video_comments(request, pk, *args, **kwags):
    ...
    '''
    commentedvideos = CommentChampionsVideo.objects.filter(uploadedvideo=pk)
