...
from ..models import Tweet, AfconVideo, CommentAfconVideo, Comment, Comment1, Comment2, Comment3
...
def see_all_video_comments(request, pk, *args, **kwags):
    ...
    '''
    commentedvideos = CommentAfconVideo.objects.filter(uploadedvideo=pk)
