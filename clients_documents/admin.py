...
from .models import Tweet, EuropaTweetLike, Comment, EuropaCommentLike, Comment1, Comment2, Comment3, EuropaCommentLike1, EuropaCommentLike2, EuropaCommentLike3


class TweetLikeAdmin(admin.TabularInline):
    model = EuropaTweetLike

class CommentLikeAdmin(admin.TabularInline):
    model = EuropaCommentLike
